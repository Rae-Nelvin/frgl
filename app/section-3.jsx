    ...
    return (
        <section className="bg-[#F8F8F8] text-[#0C1C32] min-h-screen flex flex-col pt-4 pb-40 justify-between relative w-screen overflow-hidden">
            <div className='w-max'>
                ...
                <div className='flex flex-row space-x-16 2xl:space-x-40 z-10 mt-32 2xl:mt-60'>
                    <div className='flex flex-col relative'>
                        ...
                        <img src='/images/section-3-1.png' alt='Section 3 Image 1' className='w-[300px] 2xl:w-[400px] 3xl:w-[580px] mb-3'></img>
                        <h2 className='font-bold text-lg 2xl:text-2xl 3xl:text-3xl mb-1'>Sweater Putih Keren</h2>
                        <h3 className='font-normal text-md 2xl:text-xl 3xl:text-2xl'>$75</h3>
                    </div>
                    <div className='flex flex-col z-10'>
                        <img src='/images/section-3-2.png' alt='Section 3 Image 2' className='w-[300px] 2xl:w-[400px] 3xl:w-[580px] mb-3'></img>
                        <h2 className='font-bold text-lg 2xl:text-2xl 3xl:text-3xl mb-1'>Jacket Luntur</h2>
                        <h3 className='font-normal text-md 2xl:text-xl 3xl:text-2xl'>$120</h3>
                    </div>
                    <div className='flex flex-col z-10'>
                        <img src='/images/section-3-3.png' alt='Section 3 Image 3' className='w-[300px] 2xl:w-[400px] 3xl:w-[580px] mb-3'></img>
                        <h2 className='font-bold text-lg 2xl:text-2xl 3xl:text-3xl mb-1'>Kocomoto Kuda</h2>
                        <h3 className='font-normal text-md 2xl:text-xl 3xl:text-2xl'>$2.000</h3>
                    </div>
                    <div className='flex flex-col z-10'>
                        <img src='/images/section-3-4.png' alt='Section 3 Image 4' className='w-[300px] 2xl:w-[400px] 3xl:w-[580px] mb-3'></img>
                        <h2 className='font-bold text-lg 2xl:text-2xl 3xl:text-3xl mb-1'>Keram Pants</h2>
