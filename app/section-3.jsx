            ...
            <div className='w-max'>
                ...
                <div className='flex flex-row space-x-40 z-10 mt-60'>
                    <div className='flex flex-col relative'>
                        ...
                        <Image src={"/images/section-3-1.png"} width={336} height={578} alt='Section 3 Image 1' className='w-[580px] mb-3'></Image>
                        <h2 className='font-bold text-3xl mb-1'>Sweater Putih Keren</h2>
                        <h3 className='font-normal text-2xl'>$75</h3>
                    </div>
                    <div className='flex flex-col z-10'>
                        <Image src={"/images/section-3-2.png"} width={336} height={578} alt='Section 3 Image 2' className='w-[580px] mb-3'></Image>
                        <h2 className='font-bold text-3xl mb-1'>Jacket Luntur</h2>
                        <h3 className='font-normal text-2xl'>$120</h3>
                    </div>
                    <div className='flex flex-col z-10'>
                        <Image src={"/images/section-3-3.png"} width={336} height={578} alt='Section 3 Image 3' className='w-[580px] mb-3'></Image>
                        <h2 className='font-bold text-3xl mb-1'>Kocomoto Kuda</h2>
                        <h3 className='font-normal text-2xl'>$2.000</h3>
                    </div>
                    <div className='flex flex-col z-10'>
                        <Image src={"/images/section-3-4.png"} width={336} height={578} alt='Section 3 Image 4' className='w-[580px] mb-3'></Image>
